...
<section class="container">
    ...
    <!--
       <img style="width: 90vw; height: auto; padding-right: 1.25vw" draggable="false" src="http://shenandoahliterary.org/732/files/2024/06/3.2coverrevised.png" alt="" itemprop="">
-->
<style>
    .custom-img {
...
<img class="img-fluid custom-img" src="http://shenandoahliterary.org/732/files/2024/06/3.2coverrevised.png" alt="" itemprop="">
...
-->
        ...
        <div class="row sticky-top genreNav-bar" style="background: #261CD8">
...
?>
    ...
    <div class="card-group">
        <?php
        $args = array(
            'tag' => '732', // Specify the tag to filter posts by
        );
        ...
        ?>
        <p>Oops, there are no posts with the specified tag.</p>
        <?php
        endif;
        wp_reset_postdata();
        ?>
